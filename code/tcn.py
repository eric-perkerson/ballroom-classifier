# Code based on that from https://www.kaggle.com/ceshine/pytorch-temporal-convolutional-networks
...
def main():
x_train, y_train, x_test, test_id = read_dataset("/Users/eric/BMC/data/audio_data/viennese_waltz")
